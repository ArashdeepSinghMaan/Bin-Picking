...
class ImageSaverNode(Node):
    ...
    def pointcloud_callback(self, msg):
        ...
        self.pointcloud.points = o3d.utility.Vector3dVector(cloud_arr)
    ...
    def save_images(self):
        if self.count < 3:
            ...
            o3d.io.write_point_cloud(pointcloud_filename, self.pointcloud)
            ...
            self.get_logger().info('Published saved images.')
